...
public class DashboardPage extends AbstractPage {
    ...
    private WebElement profityMarginElement;
    ...
    public String getProfitMargin(){
        return this.profityMarginElement.getText();
    }
    ...
    public int getResultsCount(){
        String resulText=this.searchResultsCountElement.getText();
        System.out.println(resulText);
        String [] arr=resulText.split(" ");
