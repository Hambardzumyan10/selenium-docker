...
//        ((JavascriptExecutor) this.driver).executeScript("arguments[0].scrollIntoView(true);", arrivalFlightsOptions);
//        this.arrivalFlightsOptions.get(random).click();
    }
    public void confirmFlight(){
        ((JavascriptExecutor) this.driver).executeScript("arguments[0].scrollIntoView(true);", this.confirmFlightsButton);
